...
export default function Footer() {
  const footerLinks = {
    ...
    browse: [
      { name: "Explore Books", href: "/explore" },
    ...
    community: [
      ...
      { name: "Literary Games", href: "/games" },
    ],
    company: [
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-gray-300 py-16 px-6 sm:px-10 relative overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute top-10 left-10 w-32 h-32 bg-blue-500/5 rounded-full blur-2xl"></div>
      <div className="absolute bottom-10 right-10 w-24 h-24 bg-cyan-500/5 rounded-full blur-xl"></div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-gray-400 leading-relaxed mb-6">
              Your AI-powered companion for discovering, exploring, and enjoying literature like never before.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              {footerLinks.ai.map((link, index) => (
                <li key={index}>
                  <Link href={link.href} className="hover:text-blue-400 transition-colors duration-300 flex items-center gap-2">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 py-8 border-t border-gray-700 border-b border-gray-700 mb-8">
          <div className="text-center">
            ...
            <div className="text-xs text-gray-400">Books Analyzed</div>
          </div>
          <div className="text-center">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">
            &copy; {currentYear} Boipoka.AI. All rights reserved. Powered by artificial intelligence.
          </p>
          ...
          <div className="flex items-center space-x-6 mt-4 md:mt-0">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="hover:text-blue-400 transition-colors duration-300" aria-label="Instagram">
